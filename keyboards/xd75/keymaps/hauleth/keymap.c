...
#define MLOWER MO(LOWER)
#define MRAISE MO(RAISE)
#define MFUNCT MO(FUNCTION)
...
/* QWERTY
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | `      | 1      | 2      | 3      | 4      | 5      | RGB KM | ESC    | =      | 6      | 7      | 8      | 9      | 0      | BACKSP |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | E      | R      | T      | RGB BW | RGB TG | RGB FW | Y      | U      | I      | O      | P      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | CTRESC | A      | S      | D      | F      | G      | HOME   | DEL    | PG UP  | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | END    | INS    | PG DN  | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LALT   | LGUI   | FN     | LOWER  | CMDSPC | MS B1  | MS B2  | MS B3  | ALGSPC | RAISE  | LEFT   | DOWN   | UP     | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [QWERTY] = { /* QWERTY */
  ...
  { KC_LCTL, KC_LALT, KC_LGUI, MFUNCT,  MLOWER, CMDSPC, KC_BTN1, KC_BTN2, KC_BTN2,  ALGSPC, MRAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT },
 },
 ...
 */
 ...
 [LOWER] = { /* LOWER */
  ...
  { KC_CAPS, _______, _______, _______, _______, _______, RGB_M_P, RGB_M_B, RGB_M_R, _______, _______, _______, _______, _______, _______ },
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | F7     | F8     | F9     | F10    | F11    | F12    | P7     | P8     | P9     | -      |        |        | PR SCR | SCR LK | PR SCR |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | PREV   | PLAY   | NEXT   | STOP   |        | P4     | P5     | P6     | +      |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | VOL-   | MUTE   | VOL+   |        |        | P1     | P2     | P3     | PENT   |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        | FN     |        |        | P0     |        | P.     | PENT   | PENT   | FN     |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [RAISE] = { /* RAISE */
  ...
  { KC_CAPS, _______, _______, _______, _______, _______, KC_P6,   KC_P5,   KC_P4,   KC_PLUS, _______, _______, _______, _______, _______ },
 ...
 */
 ...
 [FUNCTION] = { /* FUNCTION */
  ...
  { KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_SPC,  KC_P7,   KC_P8,   KC_P9,   KC_MINS, _______, _______, _______, _______ },
  { KC_CAPS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, KC_SPC, KC_P6,   KC_P5,   KC_P4,   KC_PLUS, _______, _______, _______, _______, _______ },
